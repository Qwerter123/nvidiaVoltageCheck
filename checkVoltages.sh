...
sleep $DELAY
nvidia-smi -q -d VOLTAGE -i 3 | grep Graphics > currentVoltage >> voltages_3070.txt
nvtool -i 3 --clocks | grep GPU >> voltages_3070.txt&& echo "==========">>voltages_3070.txt
TEXT="clock $clockTry MHz"
echo -e "\033[0;31m $TEXT \e[0m"
CURRENTVOLTAGE=$(nvidia-smi -q -d VOLTAGE -i 3 | grep Graphics)
